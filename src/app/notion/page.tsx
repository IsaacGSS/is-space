        ...
        <section className='space-y-10 p-10 bg-neutral-100 w-full h-full rounded-3xl'>
          ...
          <section className='flex flex-wrap items-end gap-10'>
            {Array.from({ length: 10 }).map((value, index) => (
              <div
                key={index}
                className='size-56 border border-zinc-900 rounded-md shadow-md shadow-black/20 overflow-hidden p-3 text-justify '
              >
                ...
                <span className='text-sm align-middle indent-3'>
                  ...
                  incidunt consequuntur neque. Veniam hic accusamus mollitia at.
                  Odit eum possimus dolorem.
                </span>
              </div>
            ))}
          </section>
