...
export const PageScheme = ({ modalisClous }: openModal) => {
  ...
  return (
    <div
      ...
      className='flex flex-col gap-10 h-screen lg:w-80 md:w-56 w-[500vw] aria-disabled:w-0 static transition-all duration-700 ease-in-out bg-indigo-50 drop-shadow-2xl overflow-hidden'
    >
